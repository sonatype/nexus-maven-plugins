 ...
 * projects, disable all executions of maven-deploy-plugin, and "install" itself instead. It will NOT kick in if
 * detects
...
@Component(role = AbstractMavenLifecycleParticipant.class,
    hint = "org.sonatype.nexus.maven.staging.deploy.DeployLifecycleParticipant")
public class DeployLifecycleParticipant
    extends AbstractMavenLifecycleParticipant
    implements LogEnabled
{
  /**
   * We have to have some access to GAV of the plugin, but lifecycle participant is loaded up very early, so we
   * cannot
