...
/**
 * Support for {@link TemplateInterpolatorCustomizer} instances which need {@link MasterPasswordEncryption}
 * integration.
 *
 * @since 1.4
 */
    ...
    if (encrypt && result != null) {
      try {
        ...
        throw new RuntimeException(
            "Failed to encrypt result; Master-password encryption configuration may be missing or invalid", e);
      }
    }
